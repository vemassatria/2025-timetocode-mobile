...
enum SkipButtonVariant { active, disabled }

class SkipButton extends StatelessWidget {
  final SkipButtonVariant variant;
  final VoidCallback? onPressed;

  const SkipButton({
    Key? key,
    this.variant = SkipButtonVariant.active,
    this.onPressed,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final bool isDisabled = variant == SkipButtonVariant.disabled;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            width: 2.w,
            color: isDisabled ? AppColors.secondaryText : AppColors.deepAzure,
          ),
        ),
        child: Row(
