...
class LessonDetailedScreen extends ConsumerStatefulWidget {
  final LessonModel lesson;

  const LessonDetailedScreen({super.key, required this.lesson});

  @override
  ConsumerState<LessonDetailedScreen> createState() =>
      _LessonDetailedScreenState();
}

class _LessonDetailedScreenState extends ConsumerState<LessonDetailedScreen> {
  ...
  Widget build(BuildContext context) {
    final youtubeUrl = LessonHelpers.firstYouTubeLink(widget.lesson);
      ...
      body: SafeArea(
        child: Scrollbar(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (_, i) =>
                ContentBlockCard(block: widget.lesson.content[i]),
