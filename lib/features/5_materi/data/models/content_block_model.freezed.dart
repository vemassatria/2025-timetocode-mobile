...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ContentBlockModel&&(identical(other.data, data) || other.data == data));
}
...
@override
String toString() {
  return 'ContentBlockModel(data: $data)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ContentBlockData data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ContentBlockModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ContentBlockData data)  $default,) {final _that = this;
switch (_that) {
case _ContentBlockModel():
return $default(_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ContentBlockData data)?  $default,) {final _that = this;
switch (_that) {
case _ContentBlockModel() when $default != null:
return $default(_that.data);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ContentBlockModel&&(identical(other.data, data) || other.data == data));
}
