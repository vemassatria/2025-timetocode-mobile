...
import 'package:timetocode/features/2_minigames_selection/games/challenge/presentation/widgets/challenge_card.dart';
import 'package:timetocode/features/2_minigames_selection/games/challenge/data/controllers/challenge_gameplay_controller.dart';
import 'package:timetocode/features/2_minigames_selection/games/challenge/data/controllers/challenge_progress_controller.dart';
import 'package:timetocode/features/2_minigames_selection/games/challenge/data/providers/challenge_level_provider.dart';
...
class ChallengeSelectionPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final levelCompleted = levelCompletedState.isNotEmpty
        ? levelCompletedState.last.level
        : 0;
                ...
                return ChallengeCard(
                  ...
                  onTap: isUnlocked
                      ? () {
                          ...
                          context.go('/minigames/tantangan/level');
                        }
                      : null,
                );
              },
