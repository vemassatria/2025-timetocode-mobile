...
import 'package:timetocode/features/2_minigames_selection/games/challenge/data/states/challenge_state.dart';
import 'package:timetocode/features/2_minigames_selection/games/challenge/data/models/challenge_level_model.dart';
...
class ChallengeController extends AutoDisposeNotifier<ChallengeState> {
  ...
  void exitChallenge() {
    _releaseKeepAlive();
    ref.read(routerProvider).go('/minigames/tantangan');
  }
  ...
  void endgameChallenge() {
    ref.read(routerProvider).go('/minigames/tantangan/endgame');
    ref
