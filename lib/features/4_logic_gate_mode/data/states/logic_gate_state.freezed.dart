...
mixin _$LogicGateState {
 ...
 List<BinarySlotModel>? get binarySlots; List<CardSlotModel>? get cardSlots; PlayerModel? get player; PlayerModel? get opponent; int get currentPlayerId; bool get isGameOver; int? get winnerId;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(binarySlots),const DeepCollectionEquality().hash(cardSlots),player,opponent,currentPlayerId,isGameOver,winnerId);

@override
String toString() {
  return 'LogicGateState(binarySlots: $binarySlots, cardSlots: $cardSlots, player: $player, opponent: $opponent, currentPlayerId: $currentPlayerId, isGameOver: $isGameOver, winnerId: $winnerId)';
}
...
@useResult
$Res call({
 List<BinarySlotModel>? binarySlots, List<CardSlotModel>? cardSlots, PlayerModel? player, PlayerModel? opponent, int currentPlayerId, bool isGameOver, int? winnerId
});
...
/// Create a copy of LogicGateState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? binarySlots = freezed,Object? cardSlots = freezed,Object? player = freezed,Object? opponent = freezed,Object? currentPlayerId = null,Object? isGameOver = null,Object? winnerId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<BinarySlotModel>? binarySlots,  List<CardSlotModel>? cardSlots,  PlayerModel? player,  PlayerModel? opponent,  int currentPlayerId,  bool isGameOver,  int? winnerId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LogicGateState() when $default != null:
return $default(_that.binarySlots,_that.cardSlots,_that.player,_that.opponent,_that.currentPlayerId,_that.isGameOver,_that.winnerId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<BinarySlotModel>? binarySlots,  List<CardSlotModel>? cardSlots,  PlayerModel? player,  PlayerModel? opponent,  int currentPlayerId,  bool isGameOver,  int? winnerId)  $default,) {final _that = this;
switch (_that) {
case _LogicGateState():
return $default(_that.binarySlots,_that.cardSlots,_that.player,_that.opponent,_that.currentPlayerId,_that.isGameOver,_that.winnerId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<BinarySlotModel>? binarySlots,  List<CardSlotModel>? cardSlots,  PlayerModel? player,  PlayerModel? opponent,  int currentPlayerId,  bool isGameOver,  int? winnerId)?  $default,) {final _that = this;
switch (_that) {
case _LogicGateState() when $default != null:
return $default(_that.binarySlots,_that.cardSlots,_that.player,_that.opponent,_that.currentPlayerId,_that.isGameOver,_that.winnerId);case _:
  return null;
...
class _LogicGateState implements LogicGateState {
  const _LogicGateState({final  List<BinarySlotModel>? binarySlots, final  List<CardSlotModel>? cardSlots, this.player, this.opponent, this.currentPlayerId = 1, this.isGameOver = false, this.winnerId}): _binarySlots = binarySlots,_cardSlots = cardSlots;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_binarySlots),const DeepCollectionEquality().hash(_cardSlots),player,opponent,currentPlayerId,isGameOver,winnerId);
...
/// Create a copy of LogicGateState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? binarySlots = freezed,Object? cardSlots = freezed,Object? player = freezed,Object? opponent = freezed,Object? currentPlayerId = null,Object? isGameOver = null,Object? winnerId = freezed,}) {
