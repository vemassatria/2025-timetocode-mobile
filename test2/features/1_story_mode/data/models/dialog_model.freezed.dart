...
mixin _$DialogModel {
 ...
 String get id; Map<String, String>? get conditions; List<TextDialogModel> get dialogs; String? get next; String? get nextType; BranchModel? get branch;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DialogModel&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other.conditions, conditions)&&const DeepCollectionEquality().equals(other.dialogs, dialogs)&&(identical(other.next, next) || other.next == next)&&(identical(other.nextType, nextType) || other.nextType == nextType)&&(identical(other.branch, branch) || other.branch == branch));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,const DeepCollectionEquality().hash(conditions),const DeepCollectionEquality().hash(dialogs),next,nextType,branch);

@override
String toString() {
  return 'DialogModel(id: $id, conditions: $conditions, dialogs: $dialogs, next: $next, nextType: $nextType, branch: $branch)';
}
...
@useResult
$Res call({
 String id, Map<String, String>? conditions, List<TextDialogModel> dialogs, String? next, String? nextType, BranchModel? branch
});
...
/// Create a copy of DialogModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? conditions = freezed,Object? dialogs = null,Object? next = freezed,Object? nextType = freezed,Object? branch = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,conditions: freezed == conditions ? _self.conditions : conditions // ignore: cast_nullable_to_non_nullable
as Map<String, String>?,dialogs: null == dialogs ? _self.dialogs : dialogs // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  Map<String, String>? conditions,  List<TextDialogModel> dialogs,  String? next,  String? nextType,  BranchModel? branch)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DialogModel() when $default != null:
return $default(_that.id,_that.conditions,_that.dialogs,_that.next,_that.nextType,_that.branch);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  Map<String, String>? conditions,  List<TextDialogModel> dialogs,  String? next,  String? nextType,  BranchModel? branch)  $default,) {final _that = this;
switch (_that) {
case _DialogModel():
return $default(_that.id,_that.conditions,_that.dialogs,_that.next,_that.nextType,_that.branch);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  Map<String, String>? conditions,  List<TextDialogModel> dialogs,  String? next,  String? nextType,  BranchModel? branch)?  $default,) {final _that = this;
switch (_that) {
case _DialogModel() when $default != null:
return $default(_that.id,_that.conditions,_that.dialogs,_that.next,_that.nextType,_that.branch);case _:
  return null;
...
class _DialogModel implements DialogModel {
  const _DialogModel({required this.id, final  Map<String, String>? conditions, required final  List<TextDialogModel> dialogs, this.next, this.nextType, this.branch}): _conditions = conditions,_dialogs = dialogs;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DialogModel&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other._conditions, _conditions)&&const DeepCollectionEquality().equals(other._dialogs, _dialogs)&&(identical(other.next, next) || other.next == next)&&(identical(other.nextType, nextType) || other.nextType == nextType)&&(identical(other.branch, branch) || other.branch == branch));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,const DeepCollectionEquality().hash(_conditions),const DeepCollectionEquality().hash(_dialogs),next,nextType,branch);
...
/// Create a copy of DialogModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? conditions = freezed,Object? dialogs = null,Object? next = freezed,Object? nextType = freezed,Object? branch = freezed,}) {
...
as Map<String, String>?,dialogs: null == dialogs ? _self._dialogs : dialogs // ignore: cast_nullable_to_non_nullable
as List<TextDialogModel>,next: freezed == next ? _self.next : next // ignore: cast_nullable_to_non_nullable
as String?,nextType: freezed == nextType ? _self.nextType : nextType // ignore: cast_nullable_to_non_nullable
as String?,branch: freezed == branch ? _self.branch : branch // ignore: cast_nullable_to_non_nullable
as BranchModel?,
